...
def dot_product(a, b):
    return sum(a[i] * b[i] for i in range(len(a))) #pretty cool way to do this
...
def calculate_normal(polygons, i):
    ...
    return [a[1] * b[2] - a[2] * b[1], a[2] * b[0] - a[0] * b[2], a[0] * b[1] - a[1] * b[0]] #cross product of vectors a and b